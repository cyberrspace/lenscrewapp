...
const WhyChooseUs = () => {
  return (
    <div className="flex flex-col lg:flex-row w-full max-w-[1440px] mx-auto">
      ...
      {/* Info Block */}
      <div className="flex-1 h-[500px] bg-[url('/whychooseus-bg.png')] bg-cover bg-center text-white p-6 sm:p-8">
      ...
      <div className="w-[350px] flex-shrink-0 h-[500px] bg-[#98281B] text-white p-6 sm:p-8">
        ...
        <ul className="list-disc list-inside space-y-2 text-sm">
          <li>
            <span className="font-extrabold">Acting:</span> Method Acting / Commercial
            <span className="pl-[20px] block">Acting</span>
          </li>
          <li>
            <span className="font-extrabold">Cinematography:</span> Narrative Films /
            <span className="pl-[20px] block">Advertising</span>
          </li>
          <li>
            <span className="font-extrabold">Editing:</span> Feature Films / Social Media
            <span className="pl-[20px] block">Content</span>
          </li>
        </ul>
      </div>
